  ...
  return (
    <section className="relative bg-white py-12 px-6 md:px-20">
      <div className="max-w-6xl mx-auto flex flex-col justify-center">
        {/* Title */}
        <h1 className="text-brandred text-4xl md:text-6xl font-bold text-left">
          WHAT'S PBEEX?
        </h1>

        {/* Content */}
        <div className="mt-10 text-gray-700">
          <p className="text-xl ml-20 font-bold text-center md:text-left">
          ...
          <p className="mt-6 ml-20 text-xl text-center md:text-left leading-7">
